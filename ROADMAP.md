...
- [X] Add a `requirements.txt` (NumPy as the sole core dependency)
- [X] Set up a virtual environment and confirm clean install
- [ ] Configure a test runner (`pytest`) and verify it discovers tests
- [X] Add a `CHANGELOG.md` and this `ROADMAP.md`
